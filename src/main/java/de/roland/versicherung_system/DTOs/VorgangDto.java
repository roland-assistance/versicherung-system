...
public class VorgangDto  implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        VorgangDto entity = (VorgangDto) o;
    ...
    public VorgangDto(Long id, Date vorgangsDatum, String fahrzeugTyp, String fahrzeugFarbe) {
        this.id = id;
